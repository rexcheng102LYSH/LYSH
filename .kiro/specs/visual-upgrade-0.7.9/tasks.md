...
- [x] 3. 扩展 GameState 支持新主题系统
  - [x] 3.1 在 gamestate.js 添加主题相关属性
...
- [x] 4. 实现冰晶棋子样式
  - [x] 4.1 在 css/pieces.css 添加冰晶棋子基础样式
...
- [x] 5. 实现火焰棋子样式
  - [x] 5.1 在 css/pieces.css 添加火焰棋子基础样式
...
- [x] 6. 实现冰晶落子特效
  - [x] 6.1 在 css/pieces.css 添加冰晶特效 CSS
    - 定义霜冻扩散环样式
    - 定义冰晶粒子样式
    - 定义寒气雾效样式
    - _Requirements: 2.8_
  
  - [x] 6.2 在 game_render.js 实现 createIceEffect() 函数
    - 创建霜冻扩散环动画
    - 创建冰晶粒子飞散
    - 根据特效强度调整粒子数量
...
- [x] 7. 实现火焰落子特效
  - [x] 7.1 在 css/pieces.css 添加火焰特效 CSS
    - 定义火焰爆发核心样式
    - 定义火星粒子样式
    - 定义热浪扭曲效果
    - _Requirements: 2.9_
  
  - [x] 7.2 在 game_render.js 实现 createFireEffect() 函数
    - 创建火焰爆发动画
    - 创建火星粒子飞散
    - 根据特效强度调整粒子数量
...
- [x] 8. 实现冰/火落子音效
  - [x] 8.1 在 audio_sfx.js 添加 playIceStone() 函数
    - 使用高频正弦波模拟冰晶清脆声
    - 添加玻璃碎裂噪音层
    - _Requirements: 2.6_
  
  - [x] 8.2 在 audio_sfx.js 添加 playFireStone() 函数
    - 使用低频噪音模拟火焰噼啪声
    - 添加爆裂音效层
    - _Requirements: 2.7_

- [x] 9. 实现冰/火主题 UI
  - [x] 9.1 在 game_render.js 扩展 renderPieceInCell() 函数
    - 添加 'ice_fire' 主题分支
    - 根据玩家应用对应样式类
    - _Requirements: 2.2, 2.3_
  
  - [x] 9.2 在 game_render.js 扩展 placePiece() 函数
    - 添加主题音效调用逻辑
    - 添加主题特效调用逻辑
    - _Requirements: 2.6, 2.7, 2.8, 2.9_
  
  - [x] 9.3 在 game_ui.js 添加冰火主题选择器
    - 添加 pieceGridIceFire 选项
    - 实现选择和高亮逻辑
    - _Requirements: 2.1_
  
  - [x] 9.4 在 game_ui.js 实现冰火特效调节面板
    - 实现长按进入二级面板
    - 添加特效强度选择器（关/低/中/高）
    - _Requirements: 2.10_
  
  - [x] 9.5 在 index.html 添加冰火主题 UI 元素
    - 添加棋子选择器选项
    - 添加特效调节面板 HTML
    - _Requirements: 2.1, 2.10_
  
  - [x] 9.6 在 lang.js 添加冰火主题翻译
