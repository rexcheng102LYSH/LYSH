...
/**
 * [Alpha 0.7.7.4] Asset Finalization
 * Implemented the user-provided high-fidelity SVG from Iconfont.
 * Cleaned up garbage attributes (p-id, t, hardcoded dimensions) for game engine compatibility.
 */

// 1. 棋子皮肤库
const PIECE_ICONS = {
    // 🍁 落叶：Iconfont Source (Cleaned & Optimized)
    // 原始作者：Iconfont (p-id=1665)
    maple: `
