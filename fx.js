...
/**
 * [Alpha 0.7.7.6] Asset Update
 * - Bomb: Updated to High-Fidelity Multi-color SVG (User Provided).
 * - Voodoo: Green Potion (Retained).
 * - Sun/Maple: High-Fidelity (Retained).
 */
...
// 2. 技能图标库 (Bomb Updated to Alpha 0.7.7.6 Spec)
const SKILL_ICONS = {
    ...
    // 💣 炸弹 (Bomb) - Updated to High-Fidelity SVG
