...
const I18N = {
    'zh': {
        ...
        draftTitle: "{icon} {name} (选技能)", btnUndo: "悔棋", btnExit: "退出", skillReady: "点击释放", skillUsed: "(已用)", skillName: "技能", skillNoTarget: "(缺目标)",
        confirmExit: "确定要退出吗？棋局将丢失。", pveTag: "电脑: ", names: { 1: "落叶方", 2: "生辉方" },
        titleSettings: "系统设置", lblMusicVol: "音乐音量", lblSfxVol: "音效音量", lblMusicTrack: "背景音乐",
        trackOrigin: "原初", trackOverture: "序曲 (MP3)", btnClose: "关闭",
        skills: { double: { name: "双连", desc: "本回合落两子" }, voodoo: { name: "巫毒", desc: "腐蚀一格" }, move_self: { name: "移花接木", desc: "移己方一子" }, move_enemy: { name: "乾坤大挪移", desc: "移敌方一子" }, zone: { name: "领地", desc: "划定3x3禁区" }, bomb: { name: "时间炸弹", desc: "扣除2分钟" }, god_hand: { name: "上帝之手", desc: "移任意两子" }, chaos: { name: "混乱骰子", desc: "对手随机偏移" }, short_battle: { name: "短兵战", desc: "四子即胜" }, swap: { name: "置换反应", desc: "换敌我一子" } },
        toast: { skillUsed: "技能已用尽", casting: "释放：", doubleStart: "双连：请下第1子", doubleNext: "双连：请下第2子！", voodooPick: "选择腐蚀目标", voodooDone: "腐蚀完成", moveSrcSelf: "选择己方棋子", moveSrcEnemy: "选择敌方棋子", moveDest: "选择新位置", moveDone: "移动完成", zonePick: "选择领地中心", zoneDone: "领地生成", bombStart: "炸弹爆炸！-2分钟", errInvalid: "无效操作", errZone: "禁区无法落子", undoPvP: "竞技模式无悔棋！", godPick1: "上帝之手：选第1子", godDest1: "选第1落点", godPick2: "选第2子", godDest2: "选第2落点", chaosTrigger: "混乱触发！", chaosLabel: "🎲 混乱:", shortBattleLabel: "⚔️ 短兵:", shortBattleStart: "短兵战！四子即胜", swapPickSelf: "置换：选己方", swapPickEnemy: "置换：选敌方", swapDone: "置换完成", undoDone: "悔棋成功", timeOut: "时间耗尽！" },
    ...
    'zh-TW': {
        ...
        draftTitle: "{icon} {name} (選技能)", btnUndo: "悔棋", btnExit: "退出", skillReady: "點擊釋放", skillUsed: "(已用)", skillName: "技能", skillNoTarget: "(缺目標)",
        confirmExit: "確定要退出嗎？棋局將丟失。", pveTag: "電腦: ", names: { 1: "落葉方", 2: "生輝方" },
        titleSettings: "系統設置", lblMusicVol: "音樂音量", lblSfxVol: "音效音量", lblMusicTrack: "背景音樂",
        trackOrigin: "原初", trackOverture: "序曲 (MP3)", btnClose: "關閉",
        skills: { double: { name: "雙連", desc: "本回合落兩子" }, voodoo: { name: "巫毒", desc: "腐蝕一格" }, move_self: { name: "移花接木", desc: "移己方一子" }, move_enemy: { name: "乾坤大挪移", desc: "移敵方一子" }, zone: { name: "領地", desc: "劃定3x3禁區" }, bomb: { name: "時間炸彈", desc: "扣除2分鐘" }, god_hand: { name: "上帝之手", desc: "移任意兩子" }, chaos: { name: "混亂骰子", desc: "對手隨機偏移" }, short_battle: { name: "短兵戰", desc: "四子即勝" }, swap: { name: "置換反應", desc: "換敵我一子" } },
        toast: { skillUsed: "技能已用盡", casting: "釋放技能：", doubleStart: "雙連：請下第1子", doubleNext: "雙連：請下第2子！", voodooPick: "選擇腐蝕目標", voodooDone: "腐蝕完成", moveSrcSelf: "選擇己方棋子", moveSrcEnemy: "選擇敵方棋子", moveDest: "選擇新位置", moveDone: "移動完成", zonePick: "選擇領地中心", zoneDone: "領地生成", bombStart: "炸彈爆炸！-2分鐘", errInvalid: "無效操作", errZone: "禁區無法落子", undoPvP: "競技模式無悔棋！", godPick1: "上帝之手：選第1子", godDest1: "選第1落點", godPick2: "選第2子", godDest2: "選第2落點", chaosTrigger: "混亂觸發！", chaosLabel: "🎲 混亂:", shortBattleLabel: "⚔️ 短兵:", shortBattleStart: "短兵戰！四子即勝", swapPickSelf: "置換：選己方", swapPickEnemy: "置換：選敵方", swapDone: "置換完成", undoDone: "悔棋成功", timeOut: "時間耗盡！" },
    ...
    'en': {
        ...
        draftTitle: "{icon} {name} (Draft)", btnUndo: "Undo", btnExit: "Exit", skillReady: "Cast", skillUsed: "(Used)", skillName: "Skill", skillNoTarget: "(No Target)",
        confirmExit: "Quit game? Progress lost.", pveTag: "CPU: ", names: { 1: "Autumn", 2: "Radiance" },
        titleSettings: "Settings", lblMusicVol: "Music Volume", lblSfxVol: "SFX Volume", lblMusicTrack: "Background Music",
        trackOrigin: "Origin", trackOverture: "Overture (MP3)", btnClose: "Close",
        skills: { double: { name: "Double Strike", desc: "2 moves" }, voodoo: { name: "Voodoo", desc: "Corrupt cell" }, move_self: { name: "Teleport Self", desc: "Move self" }, move_enemy: { name: "Teleport Enemy", desc: "Move enemy" }, zone: { name: "Sanctuary", desc: "3x3 Zone" }, bomb: { name: "Time Bomb", desc: "-2 Mins" }, god_hand: { name: "Hand of God", desc: "Move 2 pieces" }, chaos: { name: "Chaos Dice", desc: "Randomize opp" }, short_battle: { name: "Skirmish", desc: "Connect 4 win" }, swap: { name: "Displacement", desc: "Swap pieces" } },
        toast: { skillUsed: "Depleted", casting: "Cast: ", doubleStart: "Double: 1st", doubleNext: "Double: 2nd!", voodooPick: "Pick target", voodooDone: "Done. Move now!", moveSrcSelf: "Pick YOURS", moveSrcEnemy: "Pick ENEMY", moveDest: "Pick dest", moveDone: "Done. Move now!", zonePick: "Pick center", zoneDone: "Done. Move now!", bombStart: "Bomb! -2 Mins", errInvalid: "Invalid", errZone: "Restricted", undoPvP: "No undo in PvP!", godPick1: "God: Pick 1st", godDest1: "Dest 1", godPick2: "God: Pick 2nd", godDest2: "Dest 2", chaosTrigger: "Chaos! Missed!", chaosLabel: "🎲 Chaos:", shortBattleLabel: "⚔️ Skirmish:", shortBattleStart: "Skirmish Mode!", swapPickSelf: "Swap: Yours", swapPickEnemy: "Swap: Enemy", swapDone: "Done. Move now!", undoDone: "Undone", timeOut: "Time Out!" },
        end: { win: "Wins!", lose: "Defeat", grandWin: "👑 Grand Victory!", grandWinDesc: "{name} Wins!", score: "Score", btnNext: "Next Round", btnMenu: "Menu", btnRestart: "Replay", btnQuitMatch: "Forfeit" }
    }
};
...
function handleTurnChoice(c) {
    SoundEngine.playPlace();
    if (gameMode === 'pve') { humanSide = (c === 1) ? MAPLE : SUN; enterDraftPhase(); } 
    else { if (c === 1) { playerSides[MAPLE] = chooser; playerSides[SUN] = (chooser === 'p1' ? 'p2' : 'p1'); } else { playerSides[SUN] = chooser; playerSides[MAPLE] = (chooser === 'p1' ? 'p2' : 'p1'); } enterDraftPhase(); }
}
...
function enterDraftPhase() {
    ...
    renderSkillGrid(); updateDraftTitle(); SoundEngine.init();
}
...
function updateDraftTitle() { 
    ...
    tEl.innerHTML = t('draftTitle').replace('{icon}', ICONS[draftTurn]).replace('{name}', pickerName); 
    tEl.style.color = draftTurn === MAPLE ? '#d32f2f' : '#f9a825'; 
}

function pickSkill(id) { 
    SoundEngine.playPlace(); playerSkills[draftTurn] = id; 
    if (draftTurn === SUN) { draftTurn = MAPLE; renderSkillGrid(); updateDraftTitle(); } 
    else initGame(); 
}
...
function renderBoard() {
    ...
    for(let r=0; r<BOARD_SIZE; r++) for(let c=0; c<BOARD_SIZE; c++) {
        const cell = document.createElement('div'); cell.className = 'cell'; cell.id = `c-${r}-${c}`; cell.dataset.r=r; cell.dataset.c=c;
        cell.onclick=()=>handleCellClick(r,c); cell.onmouseenter=()=>handleCellHover(r,c);
        if(stars.some(s=>s[0]===r&&s[1]===c)) { cell.setAttribute('data-star','true'); const d=document.createElement('div'); d.className='dot'; cell.appendChild(d); }
        b.appendChild(cell);
    }
}
...
function restoreState(state) {
    ...
    for(let r=0; r<BOARD_SIZE; r++) for(let c=0; c<BOARD_SIZE; c++) {
        ...
        const val = board[r][c];
        if (val === MAPLE || val === SUN) { const pc = document.createElement('span'); pc.className='piece'; pc.innerText=ICONS[val]; cell.appendChild(pc); } 
...
function handleCellClick(r, c, bypassConfirm = false) {
    ...
    if (!bypassConfirm && !isDoubleMoveActive) {
            if (!selectedCell || selectedCell.r !== r || selectedCell.c !== c) {
                ...
                selectedCell = {r, c}; const newCell = getCell(r, c); if(newCell) newCell.classList.add('selected-move');
    ...
    if (isDoubleMoveActive) { 
        ...
        if (checkWin(r, c, currentPlayer)) handleMatchEnd(currentPlayer); 
        return; 
    }
...
function placePiece(r, c, p, m=false, chaos=false) {
    ...
    const cell = getCell(r,c); if(cell) { const pc = document.createElement('span'); pc.className='piece'; pc.innerText=ICONS[p]; cell.appendChild(pc); SoundEngine.playPlace(); }
}
function handleCellHover(r, c) {
    if (activeEffect === 'zone_pick') {
        document.querySelectorAll('.territory-preview').forEach(el => el.classList.remove('territory-preview'));
        for(let i=r-1; i<=r+1; i++) for(let j=c-1; j<=c+1; j++) if(isValid(i,j)) { const el=getCell(i,j); if(el) el.classList.add('territory-preview'); }
    }
}
function checkWinAndSwitch(r, c, p) { if (checkWin(r, c, p)) handleMatchEnd(p); else switchTurn(); }
function switchTurn() {
...
function handleSkillInteraction(r, c) {
    ...
    if (activeEffect === 'voodoo_pick') {
        ...
        const p = board[r][c]; if ((effectData.mode==='self' && p!==currentPlayer) || (effectData.mode==='enemy' && (p===EMPTY||p===currentPlayer))) { SoundEngine.playError(); return; }
        effectData.src = {r, c, val: p}; activeEffect = 'move_drop'; b.classList.remove('casting-move-src'); b.classList.add('casting-move-dest'); cell.style.opacity = '0.5'; showToast(t('moveDest', 'toast'));
        ...
        if (checkWin(r, c, src.val)) handleMatchEnd(src.val); else showToast(t('moveDone', 'toast'));
    } else if (activeEffect === 'zone_pick') {
        document.querySelectorAll('.territory-preview').forEach(el => el.classList.remove('territory-preview'));
        territoryZones.push({r, c, owner: currentPlayer, turns: 6}); updateTerritoriesUI(); activeEffect = null; b.classList.remove('casting-territory'); showToast(t('zoneDone', 'toast'));
    } else if (activeEffect === 'god_pick_1') {
        const p = board[r][c]; if (p === EMPTY || p === CORRODED) { SoundEngine.playError(); return; }
        effectData.godSrc1 = {r, c, val: p}; activeEffect = 'god_drop_1'; b.classList.remove('casting-move-src'); b.classList.add('casting-move-dest'); cell.style.opacity='0.5'; showToast(t('godDest1', 'toast'));
    } else if (activeEffect === 'god_drop_1') {
        if (board[r][c]!==EMPTY || isZoneRestricted(r,c,currentPlayer)) { SoundEngine.playError(); return; }
        const s1 = effectData.godSrc1; board[s1.r][s1.c] = EMPTY; const c1 = getCell(s1.r, s1.c); if(c1){c1.innerHTML=''; c1.style.opacity='1';}
        placePiece(r, c, s1.val, true); b.classList.remove('casting-move-dest');
        if (checkWin(r, c, s1.val)) { handleMatchEnd(s1.val); return; }
        activeEffect = 'god_pick_2'; b.classList.add('casting-move-src'); showToast(t('godPick2', 'toast'));
    } else if (activeEffect === 'god_pick_2') {
        const p = board[r][c]; if (p === EMPTY || p === CORRODED) { SoundEngine.playError(); return; }
        effectData.godSrc2 = {r, c, val: p}; activeEffect = 'god_drop_2'; b.classList.remove('casting-move-src'); b.classList.add('casting-move-dest'); cell.style.opacity='0.5'; showToast(t('godDest2', 'toast'));
        ...
        if (checkWin(r, c, s2.val)) handleMatchEnd(s2.val); else switchTurn();
    } else if (activeEffect === 'swap_pick_1') {
        const p = board[r][c]; if (p!==currentPlayer) { SoundEngine.playError(); return; }
        effectData.swapSrc = {r, c, val: p}; activeEffect = 'swap_pick_2'; b.classList.remove('casting-move-src'); b.classList.add('casting-move-dest'); cell.style.opacity = '0.5'; showToast(t('swapPickEnemy', 'toast'));
        ...
        if(c1) { c1.innerHTML=''; const pc=document.createElement('span'); pc.className='piece'; pc.innerText=ICONS[s2.val]; c1.appendChild(pc); }
        const c2 = getCell(s2.r, s2.c); if(c2) { c2.innerHTML=''; const pc=document.createElement('span'); pc.className='piece'; pc.innerText=ICONS[s1.val]; c2.appendChild(pc); }
        activeEffect = null; b.classList.remove('casting-move-dest');
        if(checkWin(s1.r, s1.c, s2.val)) { handleMatchEnd(s2.val); return; }
        if(checkWin(s2.r, s2.c, s1.val)) { handleMatchEnd(s1.val); return; }
...
function handleMatchEnd(winSide) {
    ...
    else { SoundEngine.playWin(); title = `${ICONS[winSide]} ${t('names')[winSide]} ${t('win', 'end')}`; }
    ...
    if (isBO3) {
        ...
        if ((winner==='p1'?p1Score:p2Score) >= 2) {
            ...
            bc.appendChild(cBtn(t('btnNext', 'end'), () => enterTurnSelection('pvp', null), true)); bc.appendChild(cBtn(t('btnQuitMatch', 'end'), goToMenu, false));
        }
    } else {
        const restartAction = (gameMode==='pve')?()=>enterTurnSelection('pve',aiDifficulty):()=>enterTurnSelection('pvp-single',null);
        bc.appendChild(cBtn(t('btnRestart', 'end'), restartAction, true)); bc.appendChild(cBtn(t('btnMenu', 'end'), goToMenu, false));
    }
...
function getScoreMove(adv, mas=false) {
    let max=-Infinity, ms=[]; const ai=currentPlayer, hum=currentPlayer===MAPLE?SUN:MAPLE;
    for(let r=0;r<BOARD_SIZE;r++) for(let c=0;c<BOARD_SIZE;c++) {
        if(board[r][c]!==EMPTY || isZoneRestricted(r,c,ai) || !hasNeighbor(r,c)) continue;
        let a=evalPt(r,c,ai), d=evalPt(r,c,hum), s=0;
        if(!adv) s=a+d; else { s=a*(mas?1.2:1)+d; if(a>=1e5)s=Infinity; else if(d>=1e5)s=9e7; else if(a>=1e4)s+=5e4; else if(d>=1e4)s+=4e4; }
        s+=Math.random()*10; if(s>max){max=s;ms=[{r,c}]} else if(Math.abs(s-max)<5)ms.push({r,c});
    }
    return ms.length?ms[Math.floor(Math.random()*ms.length)]:getRandomMove();
}
function evalPt(r,c,t){ let s=0; [[1,0],[0,1],[1,1],[1,-1]].forEach(d=>s+=getLn(r,c,d[0],d[1],t)); return s; }
function getLn(r,c,dr,dc,t){ 
    let ct=1,es=0,i=1; 
    while(isValid(r+dr*i,c+dc*i)&&board[r+dr*i][c+dc*i]===t){ct++;i++} 
...
function checkWin(r,c,p){ 
    ...
    for(let k of d){let ct=1; for(let s of [1,-1]){let i=r,j=c;while(true){i+=k[0]*s;j+=k[1]*s;if(!isValid(i,j)||board[i][j]!==p)break;ct++}} if(ct>=limit)return true;} 
    return false; 
}
function startBombTimer(){ if(bombInterval)clearInterval(bombInterval); bombInterval=setInterval(()=>{if(!gameActive)return;if(currentPlayer!==bombOwner){bombTime--;const m=Math.floor(bombTime/60).toString().padStart(2,'0'),s=(bombTime%60).toString().padStart(2,'0');document.getElementById('bombTimer').innerText=`${m}:${s}`;if(bombTime<=0)handleMatchEnd(bombOwner)}},1000); }
...
function updateDynamicUI(){
    ...
    let myC=0, oppC=0; board.forEach(r=>r.forEach(c=>{ if(c===currentPlayer)myC++; else if(c!==0&&c!==-1)oppC++; }));
    let viable = true;
