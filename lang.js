...
const I18N = {
    'zh-TW': {
        ...
        sideFirst: "執黑 (先手)", sideSecond: "執白 (後手)",
        ...
        pveTag: "電腦: ", 
        names: { 1: "黑方", 2: "白方" }, // 核心改动：Map 1->黑, 2->白
        titleSettings: "系統設置", 
    ...
    'zh': {
        ...
        sideFirst: "执黑 (先手)", sideSecond: "执白 (后手)",
